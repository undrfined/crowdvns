(() => {
    ...
    const addLogos = () => {
        ...
        const $crowdLogo = cr("sub", ` ${manifest.name} v${VERSION} [press ctrl+h to hide]`, "crowd-logo")
    ...
    const invalidIcon = () => {
        ...
        $icon.style = "filter: hue-rotate(310deg);"
        $icon.classList.add("fa", "fa-remove", "text-danger", "fa-fw")
        return $icon
    }
    ...
    if(localStorage.getItem('hidden') === 'true') return;
